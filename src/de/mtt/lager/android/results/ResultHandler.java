...
package de.mtt.lager.android.results;
...
public abstract class ResultHandler {
	...
	final void getDirections(double latitude, double longitude) {
		//TODO Get localization: LocaleManager.getCountryTLD(activity)
		launchIntent(new Intent(Intent.ACTION_VIEW, Uri.parse("http://maps.google." + "/maps?f=d&daddr=" + latitude + ',' + longitude)));
	}
	...
	final void openBookSearch(String isbn) {
		//TODO LocaleManager.getBookSearchCountryTLD(activity)
		Uri uri = Uri.parse("http://books.google." + 				"/books?vid=isbn" + isbn);
	...
	final void openProductSearch(String upc) {
		//TODO LocaleManager.getProductSearchCountryTLD(activity)
	...
	private String parseCustomSearchURL() {
		...
		String customProductSearch = prefs.getString(Constants.KEY_CUSTOM_PRODUCT_SEARCH,
				null);
	...
	final void searchBookContents(String isbnOrUrl) {
		...
		//TODO Implements search activity
